...
class ReportApp(tk.Tk):
    ...
    def _card(self,parent,title,description,row,column,padx=8,pady=8):
        f=ttk.Frame(parent,style="Card.TFrame",padding=(18,16)); f.grid(row=row,column=column,sticky="nsew",padx=padx,pady=pady); ttk.Label(f,text=title,style="CardTitle.TLabel").pack(anchor="w");
